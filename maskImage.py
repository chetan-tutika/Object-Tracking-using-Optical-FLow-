...
def default_vertices(ax):
    ...
    # use this for 8 point polygon and the other one for 16-point polygon
...
def maskImage(img):
    ...
    # result.save('Masked_SourceImage.png')

    # np.save('mask_array', mask)
...
if __name__ == '__main__':
    ...
    maskImage(np.array(Image.open('SourceImage.png').convert('RGB')))